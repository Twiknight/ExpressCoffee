(function() {
  ...
  tryRender = function(view, options, callback) {
    var error;
    try {
      return view.render(options, callback);
    } catch (_error) {
      error = _error;
  ...
  methods.forEach(function() {
    return app[method] = function(path) {
      var route;
  ...
  app.render = function(name, options, callback) {
    var cache, dirs, done, engines, err, opts, renderOptions, view;
    cache = this.cache;
    done = callback;
    ...
    return tryRender(view, renderOptions, done);
  };
